...
-- the difference between the primary key and the foreign key is that the primary key uniquely identifies the records within the table and it can hold unqiue and not null values
-- while foreign key establishes the  relationships between the tables by referencing the perimary key of another table. 
